...
export const FLOWERS: Flower[] = [
  ...
  { id: 'peony-pink', name: 'Піон рожевий', type: 'peony', color: '#f48fb1', price: 120, petalColor: '#f48fb1', centerColor: '#fce4ec' },
  { id: 'peony-white', name: 'Піон білий', type: 'peony', color: '#fafafa', price: 125, petalColor: '#fafafa', centerColor: '#fff9c4' },
  { id: 'peony-red', name: 'Піон червоний', type: 'peony', color: '#e53935', price: 120, petalColor: '#e53935', centerColor: '#ffcdd2' },
